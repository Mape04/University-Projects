...
- Implementarea ce utilizează repository SQL va avea 100 entități generate pseudo-aleator și salvate în baza de date. Puteți folosi liste de lastName/firstName și funcții pentru a genera date și numere aleatoare pentru a genera această listă.
...
- Implementați cu ajutorul Java 8 streams următoarele rapoarte la nivelul **serviciilor** aplicației, pentru fiecare problemă în parte.
  ...
  - **Problema 1**
  - Numărul de programări pentru fiecare patient în parte. Se vor afișa datele pacientului și numărul total de programări pentru acesta. Afișarea se va face în ordine descrescătoare a numărului de programări.
  ...
  - Numărul de zile trecute de la ultima appointment a fiecărui patient. Se vor afișa datele pacientului, data ultimei programări și numărul de zile trecute de la ultima appointment. Afișarea se va face în ordine descrescătoare a numărului de zile trecute de la ultima appointment.
